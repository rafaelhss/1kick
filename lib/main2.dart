...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'My samba de janeiro'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Stream<Uint8List> audioChunks([int seconds = 3]) async* {
    ...
    Uint8List buffer = Uint8List(max);
        ...
        child: Column(
          ...
          children: <Widget>[
            Align(
              ...
              child: FloatingActionButton(onPressed: _listenSound,
                tooltip: 'Increment',
